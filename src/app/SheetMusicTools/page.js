...
export default function SheetMusicTools() {
  ...
  return (
    <>
      {/* Add manual top border to mimic navbar separation */}
      <div className="w-full h-px bg-gray-500"></div>
  
      <main className="min-h-screen pt-6 px-6 pb-20" style={{
  background: "linear-gradient(to bottom, white 50px, #4b5583)"
